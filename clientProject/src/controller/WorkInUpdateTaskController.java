 ...
 * @author manal
 */
public class WorkInUpdateTaskController {
    ...
    public void display(int taskId, int listId) {
        ...
        button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                  JSONObject UpdateTaskRequestObject = new JSONObject();
                    try {
                       UpdateTaskRequestObject.put("id",taskId);
                        UpdateTaskRequestObject.put("status", status);
                        String parameters[] = new String[1];
                        parameters[0] = "UpdateTaskInWorkInProject";
                        RequestHandler req = new RequestHandler();

                        JSONObject resultJsonObject = req.post(parameters, UpdateTaskRequestObject);
