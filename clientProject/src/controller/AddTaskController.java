...
public class AddTaskController {
    ...
    public void display(int listId) {
        ...
        button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if (!textArea.getText().trim().equals(" ")) {
                    //task = new Task(1, textArea.getText(), colorVal, status, listId);
                    JSONObject AddTaskRequestObject = new JSONObject();
                    try {
                        AddTaskRequestObject.put("id", 1);
                        ...
                        switch (res) {
                            case "1":
                                ...
                                alert0.setContentText("Add Task Successfully ");
                                alert0.showAndWait();
                            ...
                            case "2":
                                ...
                                alert.setContentText("Add Task failed");
                                alert.showAndWait();
                    ...
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setContentText("Enter the description");
                    alert.showAndWait();
                    textArea.setText(" ");
                }
            }
